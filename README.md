...
A top-down team arena game inspired by *Brawl Stars*, reimagined as marine/navy-themed **beach volleyball**. Roster and lore seeds live in [`sailors.md`](sailors.md).
...
Assets/
  Scripts/
    ...
    Gameplay/      # ball physics, court, serve/spike/block mechanics
    Characters/    # sailor ("sailor") stats, abilities, controllers
